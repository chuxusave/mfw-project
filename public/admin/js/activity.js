...
angular.module("myApp", ["ngTable"]).value("$activityData", simpleListData);
...
(function () {
    ...
    demoController.$inject = ["NgTableParams", "$scope", "$http", "$activityData"];

    function demoController(NgTableParams, $scope, $http, $activityData) {

        var self = this;

        var simpleList = $activityData;
