...
angular.module("myApp", ["ngTable"]).value("$interestsData", simpleListData);

(function () {
    "use strict";

    angular.module("myApp").controller("demoController", demoController);
    demoController.$inject = ["NgTableParams", "$scope", "$http", "$interestsData"];

    function demoController(NgTableParams, $scope, $http, $interestsData) {

        var self = this;

        var simpleList = $interestsData;
